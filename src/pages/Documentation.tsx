  ...
  "statusCode": 400
        ...
        <Card padding="lg" shadow="lg" className="mb-6">
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-3">
              <code className="bg-gray-100 dark:bg-[#091D41] px-2 py-1 rounded">GET /api/groups</code>
            </p>
            <p className="text-sm text-gray-500 dark:text-gray-500 mb-3">
            ...
            <div className="mb-3">
              ...
              <ul className="list-disc list-inside text-sm text-gray-600 dark:text-gray-400 space-y-1 ml-4">
                <li><code className="bg-gray-100 dark:bg-[#091D41] px-1 py-0.5 rounded">instanceId</code> {t('documentation.instanceIdParam')}</li>
              </ul>
            </div>
            <CodeBlock
...
{`{
  ...
  "count": 1
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-3">
              <code className="bg-gray-100 dark:bg-[#091D41] px-2 py-1 rounded">POST /api/groups/create</code>
            </p>
            <p className="text-sm text-gray-500 dark:text-gray-500 mb-3">
            ...
            <div className="mb-3">
              ...
              <ul className="list-disc list-inside text-sm text-gray-600 dark:text-gray-400 space-y-1 ml-4">
                <li><code className="bg-gray-100 dark:bg-[#091D41] px-1 py-0.5 rounded">instanceId</code> {t('documentation.instanceIdParam')}</li>
                <li><code className="bg-gray-100 dark:bg-[#091D41] px-1 py-0.5 rounded">subject</code> {t('documentation.groupNameParam')}</li>
                <li><code className="bg-gray-100 dark:bg-[#091D41] px-1 py-0.5 rounded">description</code> {t('documentation.groupDescriptionParam')}</li>
                <li><code className="bg-gray-100 dark:bg-[#091D41] px-1 py-0.5 rounded">participants</code> {t('documentation.participantsParam')}</li>
              </ul>
            </div>
            <CodeBlock
    ...
    "participants": [
      ...
      "5511888888888"
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-3">
              <code className="bg-gray-100 dark:bg-[#091D41] px-2 py-1 rounded">POST /api/groups/validate-participants</code>
            </p>
            <p className="text-sm text-gray-500 dark:text-gray-500 mb-3">
...
{`{
  ...
  "invalid": [
    { "phone": "5511888888888", "reason": "Número não possui WhatsApp" }
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-3">
              <code className="bg-gray-100 dark:bg-[#091D41] px-2 py-1 rounded">POST /api/groups/update-subject</code>
            </p>
            <p className="text-sm text-gray-500 dark:text-gray-500 mb-3">
            ...
            <div className="mb-3">
              ...
              <ul className="list-disc list-inside text-sm text-gray-600 dark:text-gray-400 space-y-1 ml-4">
                <li><code className="bg-gray-100 dark:bg-[#091D41] px-1 py-0.5 rounded">instanceId</code> {t('documentation.instanceIdParam')}</li>
                <li><code className="bg-gray-100 dark:bg-[#091D41] px-1 py-0.5 rounded">groupId</code> {t('documentation.groupIdParam')}</li>
                <li><code className="bg-gray-100 dark:bg-[#091D41] px-1 py-0.5 rounded">subject</code> {t('documentation.groupNameParam')}</li>
              </ul>
            </div>
            <CodeBlock
  ...
  -d '{
    ...
    "subject": "Novo Nome do Grupo"
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-3">
              <code className="bg-gray-100 dark:bg-[#091D41] px-2 py-1 rounded">POST /api/groups/update-description</code>
            </p>
            <p className="text-sm text-gray-500 dark:text-gray-500 mb-3">
  ...
  -d '{
    ...
    "description": "Nova descrição do grupo"
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-3">
              <code className="bg-gray-100 dark:bg-[#091D41] px-2 py-1 rounded">POST /api/groups/update-picture</code>
            </p>
            <p className="text-sm text-gray-500 dark:text-gray-500 mb-3">
            ...
            <div className="mb-3">
              ...
              <ul className="list-disc list-inside text-sm text-gray-600 dark:text-gray-400 space-y-1 ml-4">
                <li><code className="bg-gray-100 dark:bg-[#091D41] px-1 py-0.5 rounded">instanceId</code> {t('documentation.instanceIdParam')}</li>
                <li><code className="bg-gray-100 dark:bg-[#091D41] px-1 py-0.5 rounded">groupId</code> {t('documentation.groupIdParam')}</li>
                <li><code className="bg-gray-100 dark:bg-[#091D41] px-1 py-0.5 rounded">image</code> {t('documentation.groupImageParam')}</li>
              </ul>
            </div>
            <CodeBlock
  ...
  -F "image=@/caminho/para/imagem.jpg"`}
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-3">
              <code className="bg-gray-100 dark:bg-[#091D41] px-2 py-1 rounded">POST /api/groups/update-settings</code>
            </p>
            <p className="text-sm text-gray-500 dark:text-gray-500 mb-3">
            ...
            <div className="mb-3">
              ...
              <ul className="list-disc list-inside text-sm text-gray-600 dark:text-gray-400 space-y-1 ml-4">
                <li><code className="bg-gray-100 dark:bg-[#091D41] px-1 py-0.5 rounded">instanceId</code> {t('documentation.instanceIdParam')}</li>
                <li><code className="bg-gray-100 dark:bg-[#091D41] px-1 py-0.5 rounded">groupId</code> {t('documentation.groupIdParam')}</li>
                <li><code className="bg-gray-100 dark:bg-[#091D41] px-1 py-0.5 rounded">action</code> {t('documentation.groupActionParam')}</li>
              </ul>
              <p className="text-xs text-gray-500 dark:text-gray-500 mt-2 ml-4">
  ...
  -d '{
    ...
    "action": "announcement"
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-3">
              <code className="bg-gray-100 dark:bg-[#091D41] px-2 py-1 rounded">GET /api/groups/invite-code</code>
            </p>
            <p className="text-sm text-gray-500 dark:text-gray-500 mb-3">
...
{`{
  ...
  "url": "https://chat.whatsapp.com/ABC123XYZ"
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-3">
              <code className="bg-gray-100 dark:bg-[#091D41] px-2 py-1 rounded">POST /api/groups/mention-everyone</code>
            </p>
            <p className="text-sm text-gray-500 dark:text-gray-500 mb-3">
            ...
            <div className="mb-3">
              ...
              <ul className="list-disc list-inside text-sm text-gray-600 dark:text-gray-400 space-y-1 ml-4">
                <li><code className="bg-gray-100 dark:bg-[#091D41] px-1 py-0.5 rounded">instanceId</code> {t('documentation.instanceIdParam')}</li>
                <li><code className="bg-gray-100 dark:bg-[#091D41] px-1 py-0.5 rounded">groupId</code> {t('documentation.groupIdParam')}</li>
                <li><code className="bg-gray-100 dark:bg-[#091D41] px-1 py-0.5 rounded">text</code> {t('documentation.messageTextParam')}</li>
              </ul>
            </div>
            <CodeBlock
  ...
  -d '{
    ...
    "text": "Olá a todos! Esta mensagem menciona todos os participantes."
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-3">
              <code className="bg-gray-100 dark:bg-[#091D41] px-2 py-1 rounded">POST /api/groups/leave</code>
            </p>
            <p className="text-sm text-gray-500 dark:text-gray-500 mb-3">
